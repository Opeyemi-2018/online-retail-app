                    ...
                    <div className='bg-[#0c1012] md:px-0 px-5  pt-5'>
                        ...
                        <div className=' text-white hidden md:px-5 px-2 md:flex md:flex-row  justify-between items-center max-w-[2000px]  md:max-w-[1250px] mx-auto'>
                            <div className=''>
                                ...
                                <div className=''>
                                    <Link to={'/AllProduct'} style={{ letterSpacing: '5px' }} className=' bg-[#fff]   font-bold md:flex items-center text-[#192123]  justify-between hidden md:text2xl text-1xl px-4 py-2 my-4 w-[40%] rounded-sm'>EXPLORE
                                        <IoIosArrowForward className='text-[#0c1012]'></IoIosArrowForward >
                                    </Link>
                                </div>
                            </div>
                            <div className=''>
                        ...
                        <div className=' text-white relative md:hidden w-full'>
                            ...
                            <div className=''>
                                ...
                                <div className='  flex items-center justify-center pb-4 mt-6'>
                                    <Link to={'/AllProduct'} className='bg-[#fff] text-[#0c1012] flex items-center justify-between   text-[14px] px-2 py-1 w-[40%] rounded-sm'>EXPLORE
                                        <IoIosArrowForward className='text-[#0c1012]'></IoIosArrowForward ></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#0c1012]'>
                        <div className='pt-4 md:py-2 py-1 px-2 max-w-[900px] mx-auto  flex  justify-between items-center '>
                            ...
                            <div className='text-[#fff]'>
                                <h1 className='text-[#737e80] md:font-bold font-semibold md:text-3xl text-[15px]'>Upgrade to premium speaker today</h1>
                                <p className='md:py-4 text-[#737e80]'> they are phenomenally built to deliver truly remarkable sound</p>
                                <Link to={'/Speaker'} style={{ letterSpacing: '5px' }} className='text-[#0c1012] block text-center bg-[#fff] w-full md:mt-0 mt-2  md:text-[16px] text-[14px] md:p-2 p-1 rounded-md animate-bounce'>CHECK IT OUT</Link>
                            </div>
                        </div>
                    </div>
                </section>
