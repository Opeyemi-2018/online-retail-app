    ...
    return (
        <section>
            <div className='mt-[83px] p-2 fixed top-0 z-20 w-full bg-[#0c1012]'>
                <div className='max-w-[2000px] md:px-5 px-1 md:max-w-[1250px] mx-auto flex items-center justify-center'>
                ...
                <div className='grid  grid-cols-3 gap-2 md:grid-cols-6  md:px-5 px-2   md:mt-[210px] mt-[170px] max-w-[1250px] mx-auto'>
                    {products.filter((product) => {
                        ...
                        return (
                            <div>
                                <Link to={id}>
                                    <div key={id} className='flex flex-col mb-4 md:px-4 px-2 shadow-md hover:shadow-lg ease-in-out duration-500 border-gray-200 border border-r-1 border-l-0 border-b-0 border-t-0 hover:scale-105'>
